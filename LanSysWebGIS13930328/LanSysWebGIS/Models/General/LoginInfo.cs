...
namespace LanSysWebGIS.LoginUI
{
    ...
    public class LoginInfo : ComplexObject
    {
        ...
        [Required(ErrorMessageResourceName = "ValidationErrorRequiredUserNameField", ErrorMessageResourceType = typeof(ValidationErrorResources))]
        ...
        [Required(ErrorMessageResourceName = "ValidationErrorRequiredPasswordField", ErrorMessageResourceType = typeof(ValidationErrorResources))]
