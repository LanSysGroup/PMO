...
namespace SPSSilverlight.SPSUtilities
{
    /// <summary>
    ...
    public static class CloneExtension
    {
        ...
        public static void CopyPropertiesTo(this object source, object target)
        {
            ...
            foreach (PropertyInfo sourceProperty in typeSource.GetProperties())
            {
                ...
                if (sourceProperty.Name == "Watermark" || sourceProperty.Name == "InputScope")
                    // Avoid exception with these unimplemented properties
                    continue;
