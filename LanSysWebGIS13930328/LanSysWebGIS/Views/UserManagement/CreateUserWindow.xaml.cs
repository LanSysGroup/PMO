namespace LanSysWebGIS.Views.UserManagement
{
    ...
    /// </summary>
    public partial class CreateUserWindow : ChildWindow
    {
        private IList<OperationBase> possiblyPendingOperations = new List<OperationBase>();

        /// <summary>
        /// Creates a new <see cref="CreateUserWindow"/> instance.
        /// </summary>
        public CreateUserWindow()
        {
            InitializeComponent();

            this.createUserForm.SetParentWindow(this);
            //this.loginForm.SetParentWindow(this);

            //this.LayoutUpdated += this.GoToInitialState;
            //this.LayoutUpdated += this.UpdateTitle;

            //while (WebContext.Current.Authentication.IsLoadingUser)
            //{

            //}


            //MessageBox.Show(WebContext.Current.User.Name.ToString());
        }
        ...
        //{
        //    this.Title = (this.createUserForm.Visibility == Visibility.Visible) ?
        ...
        public virtual void NavigateToRegistration()
        {
            ...
            this.createUserForm.SetInitialFocus();
        }

        /// <summary>
        /// Prevents the window from closing while there are operations in progress
        /// </summary>
        private void CreateUserWindow_Closing(object sender, CancelEventArgs eventArgs)
        {
